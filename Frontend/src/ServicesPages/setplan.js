      ...
      <div className="maindiv">
        <div className="row">
          <div className="col-sm-6 mx-auto text-black shadow-lg p-3">
            <h2><i className="text-center">¨Don’t give up on your dreams, or your dreams will give up on you.¨ </i></h2><br></br>
            <h2 className="text-center"> Set your plan here... </h2><br></br>
            <div className="container-fluid">
              <div className="row">
                ...
                <div className="col-2">
                  <button className="btn btn-dark px-5 font-weight-bold" onClick={this.handleAdd}>Add</button>
                </div>
              </div>
